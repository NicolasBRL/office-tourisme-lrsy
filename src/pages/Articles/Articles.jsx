...
const Articles = () => {
  ...
  const displayArticles = async () => {
    await axiosClient.get("/articles").then((res) => {
      setArticles(res.data.articles);
    });
  };

  const deleteArticle = async (id) => {
    axiosClient.delete(`/articles/${id}`).then(displayArticles);
  };
  ...
  return (
    <div className="w-full">
      ...
      <div className="relative overflow-x-auto shadow-sm sm:rounded-lg h-fit">
